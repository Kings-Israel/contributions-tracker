...
import { LoaderCircle, CheckCheck, X } from "lucide-vue-next";
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="lg:flex lg:justify-between mx-1">
                        ...
                        <form @submit.prevent="uploadForm.post('/expenses/upload')" method="POST" class="">
                            ...
                            <DialogFooter>
                                ...
                                <Button type="button" class="bg-blue-600 hover:bg-blue-700 focus:ring-blue-500">
                                    <a href='/expenses/template/download'>
                                        Download Template
                                    </a>
                                </Button>
                ...
                >
                    <Sheet>
                        ...
                        <SheetContent class="space-y-2">
                            ...
                            <form id="dialogForm" @submit.prevent="form.post('/expenses/store', {
                                ...
                                <FormField v-slot="{ componentField }" name="expense_type">
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input type="text" v-model="form.expense_type" placeholder="Enter the type of expense or a description" v-bind="componentField" />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                </FormField>
                                ...
                                <FormField v-slot="{ componentField }" name="date">
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input type="date" v-model="form.month" placeholder="Select the date of the expense" v-bind="componentField" />
                                        </FormControl>
                                        <FormDescription>
                                ...
                                <FormField v-slot="{ componentField }" name="reference_id">
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input type="text" v-model="form.payment_reference_id" placeholder="Enter receipt of payment" v-bind="componentField" />
                                        </FormControl>
                                        <FormDescription>
                                            Enter payment of receipt if available.
                                        </FormDescription>
                                        <FormMessage />
                                    </FormItem>
                                </FormField>
                                ...
                                <FormField v-slot="{ componentField }" name="attachment">
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input type="file" @input="form.attachment = $event.target.files[0]" placeholder="Upload Attachment" v-bind="componentField" />
                                        </FormControl>
                                        <FormDescription>
                                            Upload any relevant attachment for the expense.
                                        </FormDescription>
                                        <FormMessage />
                                    </FormItem>
                                </FormField>
                            ...
                            <SheetFooter>
                                <SheetClose as-child ref="closeSheetBtn">
                                </SheetClose>
                ...
                <TableBody v-if="expenses?.expenses.data.length > 0">
                    <TableRow v-for="expense in expenses.expenses.data" :key="expense.id">
                        ...
                        <TableCell>
                            <Dialog>
                                ...
                                <DialogContent class="sm:max-w-[500px]">
                                    ...
                                    <div class="items-center gap-4">
                                        <Label for="expense_type" class="text-right">
                                    ...
                                    <div class="items-center gap-4">
                                        <Label for="created_by" class="text-right">
                                            Created By
                                        </Label>
                                        <span>
                                            {{ expense?.user.name }}
                                    ...
                                    <div class="items-center" v-if="expense.attachment">
                                        ...
                                        <Button type="button" variant="outline" size="sm" class="text-blue-600 mt-2">
                                ...
                                <Sheet>
                                    ...
                                    <SheetContent class="space-y-2">
                                        <SheetHeader>
                                            ...
                                            <SheetDescription>
                                                Update the details of the new expense below.
                                            </SheetDescription>
                                        </SheetHeader>
                                        <form id="dialogForm" @submit.prevent="submitEdit" class="mt-4 space-y-4">
                                            <FormField name="expense_type">
                                                <FormItem>
                                                    <FormLabel>Expense Type/Description</FormLabel>
                                                    <FormControl>
                                                        <Input type="text" v-model="editForm.expense_type" placeholder="Enter the type of expense or a description" />
                                                    </FormControl>
                                                    <FormMessage />
                                                </FormItem>
                                            </FormField>
                                            ...
                                            <FormField name="amount">
                                                <FormItem>
                                                    <FormLabel>Amount</FormLabel>
                                                    <FormControl>
                                                        <Input type="number" min="1" v-model="editForm.amount" step=".01" placeholder="Enter the amount" />
                                                    </FormControl>
                                                    <FormMessage />
                                                </FormItem>
                                            </FormField>
                                            ...
                                            <FormField name="reference_id">
                                                <FormItem>
                                                    <FormLabel>Expense Payment Receipt</FormLabel>
                                                    <FormControl>
                                                        <Input type="text" v-model="editForm.payment_reference_id" placeholder="Enter receipt of payment" />
                                                    </FormControl>
                                                    <FormDescription>
                                                        Enter payment of receipt if available.
                                                    </FormDescription>
                                            ...
                                            <FormField name="attachment">
                                                <FormItem>
                                                    <FormLabel>Attachment</FormLabel>
                                                    <FormControl>
                                                        <Input type="file" @input="editForm.attachment = $event.target.files[0]" placeholder="Upload Attachment" />
                                                    </FormControl>
                                                    <FormDescription>
                                                        Upload any relevant attachment for the expense.
                                                    </FormDescription>
                            ...
                            <Dialog>
                                <DialogTrigger as-child>
                                    <Button variant="ghost" size="sm" class="text-green-600" v-if="expense?.can_approve" @click="approveForm.expense_id = expense.id">
                                ...
                                <DialogContent class="sm:max-w-[500px]">
                                    ...
                                    <DialogFooter>
                                        ...
                                        <form @submit.prevent="approveForm.post('/expenses/status/update')" method="POST" class="">
                            ...
                            <Dialog>
                                <DialogTrigger as-child>
                                    <Button variant="ghost" size="sm" class="text-red-600" v-if="expense?.can_approve" @click="rejectForm.expense_id = expense.id">
                                ...
                                <DialogContent class="sm:max-w-[500px]">
                                    ...
                                    <DialogFooter>
                                        ...
                                        <form @submit.prevent="rejectForm.post('/expenses/status/update')" method="POST" class="">
